import styles from "./SingleSwiper.module.css";
...
export default function SingleSwiper(props: Props) {
  ...
  return (
    <div
      className={styles.single_swiper}
      style={{
    ...
    >
      ...
      >
        ...
        <SwiperSlide>
          <div className={`${styles.single_last} ${styles.slide_div}`}>
            {!props.notFound ? (
              <button
                id={styles.single_load_more}
